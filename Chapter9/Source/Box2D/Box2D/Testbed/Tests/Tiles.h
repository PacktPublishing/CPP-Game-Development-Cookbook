...
float a = 2.8f; // 4 bytes
int b = a; // 4 bytes ( implicit conversion .. C style conversion). Even worse
int b = (int)a; // explicit conversion...C style conversion . Bad practises of C++ 

// 3 types : static cast, dynamic cast, lexical cast:: boost, reinterpret_cast

int b = static_cast<int>(a); // C++ style 
